...
class Biometry{
    ...
    static public function add($data){
        $stmt = DB::connect()->prepare('INSERT INTO biometry (date,age,doctor_name,weight,height,id_patient,id_doctor) VALUES (:date,:age,:doctor_name,:weight,:height,:id_patient,:id_doctor);');
    ...
    static public function update($data){
        ...
        // print_r($data);
        // die;
        $stmt = DB::connect()->prepare('UPDATE biometry SET date = :date, age = :age , weight = :weight ,height = :height , id_patient = :id_patient WHERE id =:id');
