...
if (isset($_POST['id']) && !isset($_POST['submit'])) {
  $existAllergy = new AllergiesController();
  $Allergy = $existAllergy->getOneAllergy();
//   echo'<pre>';
//   print_r($Allergy);
            ...
            <div class="w-1/2 bg-white rounded shadow-2xl p-8 m-4">
              ...
              <form method="post">
                <div class="flex flex-col mb-4">
                  ...
                  <input class="border py-2 px-3 text-grey-800" type="date" name="date" id="date" value="<?php echo $Allergy->date; ?>" required>
                  <input type="hidden" name="id" value="<?php echo $Allergy->id; ?>">
                </div>
                <div class="flex flex-col mb-4">
                  <label class="mb-2 font-bold text-lg text-gray-900" for="allergy">Allergy</label>
                  <input class="border py-2 px-3 text-grey-800" type="text" name="allergy" id="allergy" value="<?php echo $Allergy->allergy; ?>" required>
                </div>
                <div class="flex flex-col mb-4">
                  <label class="mb-2 font-bold text-lg text-gray-900" for="diagnostic">Diagnostic Method</label>
                  <input class="border py-2 px-3 text-grey-800" type="text" name="diagnostic" id="diagnostic" value="<?php echo $Allergy->diagnostic_method; ?>" required>
                </div>
                <div class="flex flex-col mb-4">
                  <label class="mb-2 font-bold text-lg text-gray-900" for="treatment">Treatment</label>
                  <input class="border py-2 px-3 text-grey-800" type="text" name="treatment" id="treatment" value="<?php echo $Allergy->treatment; ?>" required>
                </div>
                <div class="pt-4 flex items-center justify-center">
                  <a class="flex justify-center items-center w-40 text-gray-900 px-4 py-3 rounded-md focus:outline-none" href="<?php echo BASE_URL; ?>displayAllergies">
