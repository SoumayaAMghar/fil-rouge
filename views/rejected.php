    ...
    <section class="min-h-screen flex items-stretch text-black ">
        ...
        <div class="lg:w-1/2 w-full flex items-center justify-center text-center md:px-16 px-0 z-0" style="background-color: #edf4ff;">
            ...
            <div class="w-full mb-16 px-24 z-10 ">
                <h1 class="text-3xl font-bold text-left tracking-wide text-center">Your request has been rejected.</h1>
                <p>For more information please contact us on admin@admin.com</p>
