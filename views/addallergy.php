...
if(isset($_POST['submit'])){
    $newallergy= new AllergiesController();
    $newallergy->addAllergy();
}   
        ...
        <div class="container mx-auto px-6 py-8">
          ...
          <div class="flex justify-center items-center w-full ">
                                <div class="w-1/2 bg-white rounded shadow-2xl p-8 m-4">
                                    <h1 class="block w-full text-center text-gray-800 text-2xl font-bold mb-6">ADD ALLERGY</h1>
                                    <form method="post">
                                        ...
                                        <div class="flex flex-col mb-4">
                                            ...
                                            <input class="border py-2 px-3 text-grey-800" allergy="text" name="allergy" id="allergy" required>
                                        </div>
                                        <div class="flex flex-col mb-4">
                                            <label class="mb-2 font-bold text-lg text-gray-900" for="diagnostic">Diagnostic method</label>
                                            <input class="border py-2 px-3 text-grey-800" type="text" name="diagnostic" id="diagnostic" required>
                                        </div>
                                        <div class="flex flex-col mb-4">
                                            <label class="mb-2 font-bold text-lg text-gray-900" for="treatment">treatment</label>
                                            <input class="border py-2 px-3 text-grey-800" type="text" name="treatment" id="treatment" required>
                                        </div>                                        
