                                ...
                                <div class="w-1/2 bg-white rounded shadow-2xl p-8 m-4">
                                    ...
                                    <form method="post">
                                        ...
                                        <div class="flex flex-col mb-4">
                                            ...
                                            <input class="border py-2 px-3 text-grey-800" allergy="text" name="allergy" id="allergy">
                                        </div>
                                        <div class="flex flex-col mb-4">
                                            <label class="mb-2 font-bold text-lg text-gray-900" for="diagnostic">Diagnostic</label>
                                            <input class="border py-2 px-3 text-grey-800" type="text" name="diagnostic" id="diagnostic" >
                                        </div>
                                        <div class="flex flex-col mb-4">
                                            <label class="mb-2 font-bold text-lg text-gray-900" for="treatment">treatment</label>
                                            <input class="border py-2 px-3 text-grey-800" type="text" name="treatment" id="treatment" >
                                        </div>                                        
