...
<nav class="relative w-full flex flex-wrap items-center justify-between py-4 bg-gray-100 text-gray-500 hover:text-gray-700 focus:text-gray-700 shadow-lg navbar navbar-expand-lg navbar-light">
  <div class="container-fluid w-full flex flex-wrap items-center justify-between px-6">
    ...
    float-left py-2 list-none text-left rounded-lg shadow-lg
      ...
      <?php foreach ($doctors as $doctor) : ?>
       <!-- <?php
        ...
        <tr>
          ...
          <th scope="row"><?php echo $doctor['firstname'] . $doctor['lastname']; ?></th>
          <td><?php echo $doctor['speciality']; ?></td>
          <td><?php echo $doctor['phone']; ?></td>
          <td><?php echo $doctor['email']; ?></td>
          <td><?php echo $doctor['patente']; ?></td>
          <td><?php echo $doctor['status']; ?></td>
          <td class="d-flex flex-row">
            <form method="post" class="mr-1" >
              <input type="hidden" class="status" name="status" >
              <input type="hidden" class="idDoctor" name="id" >
              <div class="flex">
              <button name="submit" class="btn btn-sm btn-success accepted mr-11 ml-11" value="<?php echo $doctor['id']; ?>"><i class="fa-solid fa-check"></i>accepted</button>
              <button name="submit" class="btn btn-sm btn-danger rejected" value="<?php echo $doctor['id']; ?>"><i class="fa-solid fa-xmark-to-slot"></i> rejected</button>
              </div>
